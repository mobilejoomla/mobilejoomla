...
do
	...
	then
		...
		sed -i -e "s|###VERSION###|$MJ_VERSION|g" -e "s|###DATE###|$MJ_DATE|g" -e "s|###URL###|$MJ_URL|g" -e "s|###DESC###|$MJ_DESC|g" -e "s|###AUTHOR###|$MJ_AUTHOR|g" -e "s|###EMAIL###|$MJ_EMAIL|g" -e "s|###COPYRIGHT###|$MJ_COPYRIGHT|g" -e "s|###LICENSE###|$MJ_LICENSE|g" $F
	fi
done
