...
<script src="<?php echo $base?>/resources/scripts/templates.js" type="text/javascript"></script>
...
<?php
	...
	if ($modulepos && $this->countModules($modulepos) > 0 && (!$MobileJoomla->_ishomepage || $MobileJoomla->config['tmpl_xhtml_componenthome'])):
		?><div id="<?php echo $modulepos; ?>"><?php $MobileJoomla->loadModules($modulepos); ?></div><?php
	endif;
?>
<div class="top"><a href="#header">Back to the top</a></div>
<?php
	if (!$MobileJoomla->_ishomepage) {
		?><div class="home"><a href="<?php echo $this->baseurl?>">Home</a></div><?php
	}
?>
</div>
<div id="footer">
