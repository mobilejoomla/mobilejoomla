...
<tr>
	<td class="key"><span class="editlinktip hasTip" title="<?php echo JText::_('Decrease Image Width'); ?>::<?php echo JText::_('Pixels to further decrease width of your already rescaled image, preserving aspect ratio. Write an integer.'); ?>"><?php echo JText::_('Decrease Image Width'); ?></span></td>
	<td><input class="text_area" type="text" size="10" name="mjconfig_xhtml_buffer_width" value="<?php echo $MobileJoomla_Settings['xhtml_buffer_width']; ?>" /></td>
</tr>
</tbody>
</table>
</fieldset>
...
<tr>
	<td class="key"><span class="editlinktip hasTip" title="<?php echo JText::_('Decrease Image Width'); ?>::<?php echo JText::_('Pixels to further decrease width of your already rescaled image, preserving aspect ratio. Write an integer.'); ?>"><?php echo JText::_('Decrease Image Width'); ?></span></td>
	<td><input class="text_area" type="text" size="10" name="mjconfig_iphone_buffer_width" value="<?php echo $MobileJoomla_Settings['iphone_buffer_width']; ?>" /></td>
</tr>
</tbody>
</table>
</fieldset>
...
<tr>
	<td class="key"><span class="editlinktip hasTip" title="<?php echo JText::_('Decrease Image Width'); ?>::<?php echo JText::_('Pixels to further decrease width of your already rescaled image, preserving aspect ratio. Write an integer.'); ?>"><?php echo JText::_('Decrease Image Width'); ?></span></td>
	<td><input class="text_area" type="text" size="10" name="mjconfig_wml_buffer_width" value="<?php echo $MobileJoomla_Settings['wml_buffer_width']; ?>" /></td>
</tr>
</tbody>
</table>
</fieldset>
...
<tr>
	<td class="key"><span class="editlinktip hasTip" title="<?php echo JText::_('Decrease Image Width'); ?>::<?php echo JText::_('Pixels to further decrease width of your already rescaled image, preserving aspect ratio. Write an integer.'); ?>"><?php echo JText::_('Decrease Image Width'); ?></span></td>
	<td><input class="text_area" type="text" size="10" name="mjconfig_chtml_buffer_width" value="<?php echo $MobileJoomla_Settings['chtml_buffer_width']; ?>" /></td>
</tr>
</tbody>
</table>
</fieldset>
...
<div id="mjupdate">
    ...
    New MobileJoomla version is available for <a href="http://www.mobilejoomla.com/download.html" alt="<?php echo JText::_('Learn more on www.mobilejoomla.com'); ?>" target="_blank">updating</a>.
</div>
<div id="mjnoupdate">
...
<?php echo JText::_('You can find more extensions from'); ?> <a href="http://www.mobilejoomla.com/"><?php echo JText::_('MobileJoomla homepage'); ?></a>.
</td></tr>
</tbody>
</table>
<?php
        ...
        function displayConfigTmpl ($tmpl, &$config, $prefix)
        {
			...
			if (JFolder::exists ($jcompath))
			{
				...
				{
					if ($entry == '.' || $entry == '..' || !is_dir (JPATH_SITE . DS . 'components' . DS . 'com_jcomments' . DS . 'tpl' . DS . $entry))
						continue;
				...
				$userLevels = array (
					JHTML::_('select.option', 'Unregistered', 'Unregistered'),
