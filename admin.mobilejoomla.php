...
//Plugin settings
	$useragents = array(
		...
		JHTML::_('select.option', 2, JText::_('WURFL'), 'value', 'text', !$wurfl ),
...
//WURFL settings
	$wurflcache = array(
		JHTML::_('select.option', 0, JText::_('No') ),
		JHTML::_('select.option', 1, JText::_('Single file') ),
		JHTML::_('select.option', 2, JText::_('Multicache') )
	);
	$lists['wurflcache'] = JHTML::_('select.genericlist', $wurflcache, 'mjconfig_wurflcache', 'class="inputbox" size="1"', 'value', 'text', $MobileJoomla_Settings['wurflcache'] );
