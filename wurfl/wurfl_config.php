...
define("DATADIR", JPATH_SITE.DS.'administrator'.DS.'components'.DS.'com_mobilejoomla'.DS.'wurfl'.DS.'data'.DS);

// Path and filename of wurfl_parser.php
define("WURFL_PARSER_FILE", JPATH_SITE.DS.'administrator'.DS.'components'.DS.'com_mobilejoomla'.DS.'wurfl'.DS.'wurfl_parser.php');

// Path and filename of wurfl_class.php
define("WURFL_CLASS_FILE", JPATH_SITE.DS.'administrator'.DS.'components'.DS.'com_mobilejoomla'.DS.'wurfl'.DS.'wurfl_class.php');
...
if(!defined("WURFL_USE_MULTICACHE"))
...
define ("MULTICACHE_DIR", DATADIR."multicache".DS);

// Temporary directory for manual updates.
define ("MULTICACHE_TMP_DIR", DATADIR."multicache_tmp".DS);
