...
/**/						if(is_object($MobileJoomla))
/**/						{
/**/							$markup=$MobileJoomla->getMarkup();
/**/							$markupext=array('xhtml'=>'xhtmlmp','wml'=>'wml','chtml'=>'chtml','iphone'=>'iphone');
/**/							if(isset($markupext[$markup]))
/**/							{
/**/								$mobilejoomlaviews = JPATH_ADMINISTRATOR.DS.'components'.DS.'com_mobilejoomla'.DS.'views'.DS.$markupext[$markup].DS.$option.DS.$this->getName();
/**/								$this->_addPath('template', $mobilejoomlaviews);
/**/							}
/**/						}
/**/					}
