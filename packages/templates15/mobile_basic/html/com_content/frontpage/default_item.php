...
<?php if (($params->get('show_author')) or ($params->get('show_category')) or ($params->get('show_create_date')) or ($params->get('show_section')) or ($params->get('show_modify_date'))) : ?>
<div class="article-info">
<?php endif; ?>
<?php if ($params->get('show_section') && $this->item->sectionid && isset($this->item->section)) : ?>
<div class="parent-category-name">
<?php $title = $this->escape($this->item->section); ?>
...
<?php endif; ?>
<?php if ((int)$this->item->modified !== 0 && $params->get('show_modify_date')) : ?>
...
<?php echo JText::sprintf('Written by', $this->escape($author)); ?>
</div>
<?php endif; ?>	
