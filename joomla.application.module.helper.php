...
/**/				{
/**/					$chromePath = JPATH_ADMINISTRATOR.DS.'components'.DS.'com_mobilejoomla'.DS.'views'.DS.$markupext[$markup].DS.'modules.php';
/**/					if(!isset($chrome[$chromePath]))
/**/					{
/**/						if(file_exists($chromePath)) require_once ($chromePath);
